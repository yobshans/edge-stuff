...
sudo tc qdisc add dev dcn1-data root netem delay 200ms limit 15000000
...
sudo tc qdisc add dev ifb0 root netem delay 200ms limit 15000000

sudo tc qdisc add dev dcn2-data root netem delay 200ms limit 15000000
...
sudo tc qdisc add dev ifb1 root netem delay 200ms limit 15000000

sudo tc qdisc add dev dcn1-management root netem delay 200ms limit 15000000
...
sudo tc qdisc add dev ifb2 root netem delay 200ms limit 15000000

sudo tc qdisc add dev dcn2-management root netem delay 200ms limit 15000000
...
sudo tc qdisc add dev ifb3 root netem delay 200ms limit 15000000
